...
public class MovementController : MonoBehaviour
{
    ...
    private void Movement()
    {
        ...
        Vector3 inputVector = new Vector3(horizontalInput, 0, verticalInput).normalized * _speed * Time.fixedDeltaTime;  
        Vector3 newPostion = rb.position + rb.transform.TransformDirection(inputVector); 
    ...
    {
        // Crouch Delay, prevents from glitchy camera/movement
